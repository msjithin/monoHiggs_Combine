...
get_et(){
    ...
    combine -M FitDiagnostics -d ../2hdma_med400_ps100/et_workspace_400_${year}.root -m 400 --saveShapes --saveWithUncertainties --robustFit 1 --rMin -20 --rMax 20 --freezeParameters r --setParameters r=0 --customStartingPoint
    ...
    cp _postfit_*et*${year}*  ~/public_html/limits/sample_new/sample/${year}_till2000GeV/
}

get_mt(){
    combineTool.py -M T2W -i ../2hdma_med400_ps100/xtt_mt_1_13TeV_${year}.txt -o mt_workspace_400_${year}.root
    combine -M FitDiagnostics -d ../2hdma_med400_ps100/mt_workspace_400_${year}.root -m 400 --saveShapes --saveWithUncertainties --robustFit 1 --rMin -20 --rMax 20 --freezeParameters r --setParameters r=0 --customStartingPoint
    ...
    cp _Finalplot_xtt_mt_1_*${year}* ~/public_html/limits/sample_new/sample/${year}_till2000GeV/
    python postFitPlot_v3.py -ch mt -y ${year}
    cp _postfit_*mt*${year}*  ~/public_html/limits/sample_new/sample/${year}_till2000GeV/

}

get_tt(){
    combineTool.py -M T2W -i ../2hdma_med400_ps100/xtt_tt_1_13TeV_${year}.txt -o tt_workspace_400_${year}.root
    combine -M FitDiagnostics -d ../2hdma_med400_ps100/tt_workspace_400_${year}.root -m 400 --saveShapes --saveWithUncertainties --robustFit 1 --rMin -20 --rMax 20 --freezeParameters r --setParameters r=0 --customStartingPoint
    ...
    cp _Finalplot_xtt_tt_1_*${year}* ~/public_html/limits/sample_new/sample/${year}_till2000GeV/
    python postFitPlot_v3.py -ch tt -y ${year}
    cp _postfit_*tt*${year}*  ~/public_html/limits/sample_new/sample/${year}_till2000GeV/
}
get_cmb(){
    combineTool.py -M T2W -i ../2hdma_med400_ps100/xtt_cmb_1_13TeV_${year}.txt -o cmb_workspace_400_${year}.root
    combine -M FitDiagnostics -d ../2hdma_med400_ps100/cmb_workspace_400_${year}.root -m 400 --saveShapes --saveWithUncertainties --robustFit 1 --rMin -20 --rMax 20 --freezeParameters r --setParameters r=0 --customStartingPoint
    ...
    cp _Finalplot_xtt_cmb_1_*${year}* ~/public_html/limits/sample_new/sample/${year}_till2000GeV/
    # python postFitPlot_v3.py -ch cmb -y ${year}
    # cp _postfit_*cmb*  ~/public_html/limits/sample_new/sample/${year}_till2000GeV/
