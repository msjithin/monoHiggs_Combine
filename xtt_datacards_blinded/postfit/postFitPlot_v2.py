...
def plotCR():
    ...
    f_ref = TFile('common/et_2017_2hdma_med400_ps150.root',"r")
    hist_ref  = f_ref.Get('xtt_et_1_13TeV/data_obs')
    ...
    prefit_hs = fin.Get('shapes_prefit' + '/' + 'xtt_et_1_13TeV' + '/total_background')
    postfit_hs = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/total_background')
    data_graph = fin.Get('shapes_prefit' + '/' + 'xtt_et_1_13TeV' +'/data')
    data_hs =  makeHistogram(data_graph,prefit_hs)
    #fitfile.getOtherBkg(cr)
    #other_bkg = fitfile.other_bkg
    ZTTjet = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/' + 'ZTTjet')
    ZLLjet = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/' + 'ZLLjet')
    jetFakes = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/' + 'jetFakes')    
    TT     = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/' + 'TT')
    STT = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/' + 'STT')
    VVT = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/' + 'VVT')
    otherMC = fin.Get('shapes_fit_b' + '/' + 'xtt_et_1_13TeV' + '/' + 'otherMC')
    ...
    prefit_hs.SetMaximum(1.5*(prefit_hs.GetMaximum()))
    ...
    leg = getLegend(0.75 , 0.6, 0.9, 0.9)
    ...
    texCMS,texLumi = getCMSText('8.2 fb-1','2017')
