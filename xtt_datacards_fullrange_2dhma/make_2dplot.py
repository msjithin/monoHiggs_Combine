...
def make_plot(channel = '', year='2017', data_obs=[], data_exp=[], data_exp_p1=[], data_exp_m1=[], cat=''):
    ...
    if _year=='20172018':
        _year= '2017+2018'
    h_col = TH2F("h_col","2HDMa Limit "+channel+" "+_year, len(mA_ticks), 0, len(mA_ticks), len(ma_ticks), 0, len(ma_ticks))
    ...
    h_col.GetXaxis().SetTitle('mass A [GeV]')
    h_col.GetYaxis().SetTitle('mass a [GeV]')
    gPad.SetGrid()
    gPad.SetRightMargin(0.2) 
    c03.SaveAs("2hdma_limit_"+channel+"_"+year+"_"+cat+".png")
