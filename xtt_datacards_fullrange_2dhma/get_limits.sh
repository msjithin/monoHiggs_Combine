...
cmb(){
    get_cmb
    combineTool.py -M CollectLimits 2HDMa_bb_*/*.limit_cmb.* --use-dirs -o limits/limits_cmb.json
    combineTool.py -M CollectLimits 2HDMa_gg_*/*.limit_cmb.* --use-dirs -o limits/limits_cmb.json
