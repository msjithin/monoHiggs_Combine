...
get_cmb(){
	...
	echo $i
	#get_combineCards
	combineTool.py -M T2W -i ${i}/xtt_cmb_1_13TeV_2017.txt -o cmb_workspace_2017.root
	combineTool.py -M AsymptoticLimits -t -1 -d ${i}/cmb_workspace_2017.root --there -n .limit_2017_cmb --expectSignal=0  --parallel 10 --cminDefaultMinimizerStrategy 0 --rMin -20 --rMax 20 --X-rtd MINIMIZER_analytic --X-rtd FAST_VERTICAL_MORPH
    done   
}
...
cmb(){
    get_cmb
    combineTool.py -M CollectLimits 2hdma*/*.limit_2017_cmb.* --use-dirs -o limits/limits_2017_cmb.json
    #python gather_limits.py -ch cmb -y '2017'
