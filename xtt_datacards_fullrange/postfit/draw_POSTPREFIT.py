...
def MakePlot_v2(cat='prefit', ch='et',  year="2017", Status=''):
    ...
    infile=ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med200_ps150_'+year+'.root',"r")
    ...
    #    ncat=
    category = 'xtt_'+Channel+'_1_13TeV_'+cat
    ...
    infile1 = ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med200_ps150_'+year+'.root',"r")
    infile2 = ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med300_ps150_'+year+'.root',"r")
    infile3 = ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med400_ps100_'+year+'.root',"r")
    infile4 = ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med500_ps150_'+year+'.root',"r")
    infile5 = ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med600_ps150_'+year+'.root',"r")
    infile6 = ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med700_ps300_'+year+'.root',"r")
    infile7 = ROOT.TFile('postfit_shapes_'+ch+'_2hdma_med800_ps300_'+year+'.root',"r")

    Signal1= infile1.Get("xtt_"+ch+"_1_13TeV_prefit/MH3_200_MH4_150")
    Signal2= infile2.Get("xtt_"+ch+"_1_13TeV_prefit/MH3_300_MH4_150")
    Signal3= infile3.Get("xtt_"+ch+"_1_13TeV_prefit/MH3_400_MH4_100")
    Signal4= infile4.Get("xtt_"+ch+"_1_13TeV_prefit/MH3_500_MH4_150")
    Signal5= infile5.Get("xtt_"+ch+"_1_13TeV_prefit/MH3_600_MH4_150")
    Signal6= infile6.Get("xtt_"+ch+"_1_13TeV_prefit/MH3_700_MH4_300")
    Signal7= infile7.Get("xtt_"+ch+"_1_13TeV_prefit/MH3_800_MH4_300")

    # Signal1.Scale( 50)  # CS x BR  1000_400_440  // factor of 2 is added as we consider the full doublet
    # Signal2.Scale( 50)
    # Signal3.Scale( 50)
    # Signal4.Scale( 50)
    # Signal5.Scale( 50)
    ...
    if ch=='et' or ch=='mt':
        stack.Add(ZLLjet)
    stack.Add(ZTTjet)
    print 'ZTTjet ', ZTTjet.Integral()
    if ch=='et' or ch=='mt':
        print 'ZLLjet ', ZLLjet.Integral()
    print 'jetFakes' , jetFakes.Integral()
    print 'TT' , TT.Integral()
    print 'STT' , STT.Integral()
    print 'VVT' , VVT.Integral()
    print 'otherMC' , otherMC.Integral()
    print '--------------------------------'
    total_bkg = ZTTjet.Integral() +jetFakes.Integral() +TT.Integral() + STT.Integral() +VVT.Integral() +otherMC.Integral()
    if ch=='et' or ch=='mt':
        total_bkg +=  ZLLjet.Integral()
    print 'total bkg', total_bkg
    print '--------------------------------'
    ...
    if Status == "LOG" :Data.SetMaximum(max(Data.GetMaximum() , stack.GetMaximum()) *1500); Data.SetMinimum(0.1)
    #    if Status == "LOG" :Data.SetMaximum(999); Data.SetMinimum(0.01)
    if Status=="": Data.SetMaximum( max(Data.GetMaximum() , stack.GetMaximum())    *1.5) ;  Data.SetMinimum(0)
    ...
    legende.AddEntry(Signal3,"2hdma_med400_ps100","l")
    ...
    c.SaveAs("_Finalplot_"+prefix+category+Status+"_"+Channel+"_"+year+".png")
...
if __name__=="__main__":
    ...
    MakePlot_v2('prefit', ch, year, Status="LOG")
    #MakePlot_v2('postfit', ch, year)
